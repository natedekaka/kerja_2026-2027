...
## REVIEW & PROYEK MINI SEMESTER 1 (TP.5.1 + TP.5.2)
...
| Elemen | Review lintas elemen (BK + TIK + SK + JKI) |
| Tujuan Pembelajaran | TP.5.1: Mereview seluruh materi semester 1 TP.5.2: Proyek mini lintas elemen |
| Alokasi Waktu | 4 JP (2 × 45 menit) — 2 pertemuan |
| Pertemuan ke- | 16 |
...
| Metode | Kuis interaktif, mind mapping kelompok, presentasi, tantangan proyek mini, showcase hasil |
...
1. Mengingat dan menghubungkan konsep-konsep dari 4 elemen (BK, TIK, SK, JKI) dalam satu peta konsep utuh.
2. Mengidentifikasi miskonsepsi atau pemahaman yang masih kurang melalui kuis review interaktif.
3. Menerapkan dekomposisi (BK) untuk memecahkan masalah nyata di sekolah.
4. Menghasilkan solusi digital kreatif yang mengintegrasikan TIK, SK, dan JKI.
5. Menyajikan dan mempertahankan solusi dalam presentasi kelompok.

#### B.2 Indikator Keberhasilan

| Indikator | Kriteria |
|---|---|
| Skor kuis review minimal 70% | 14 dari 20 soal benar |
| Mind map mencakup 4 elemen dengan hubungan yang logis | 4 elemen terwakili, minimal 3 hubungan antar elemen |
| Produk proyek mini sesuai kriteria: relevan, digital, aplikatif | Memenuhi 3 dari 3 kriteria |
| Presentasi jelas, semua anggota aktif, menjawab pertanyaan | Semua anggota bicara, menjawab ≥ 2 pertanyaan |

#### B.3 Kata Kunci

Review, dekomposisi, pengenalan pola, abstraksi, algoritma, sistem komputer, jaringan, topologi, enkripsi, integrasi, solusi digital
...
Nilai rata-rata kuis Kahoot/Quizizz sebagai indikator pemahaman awal. Soal mencakup 4 elemen secara proporsional.

#### D.2 Asesmen Formatif

Observasi selama pembuatan mind map dan kerja proyek. Guru mencatat kemampuan kolaborasi, kontribusi individu, dan proses berpikir komputasional.

#### D.3 Asesmen Sumatif

1. Skor kuis Kahoot/Quizizz (formatif menjadi sumatif)
2. Produk mind map
3. Produk proyek mini + presentasi
...
| Relevansi Solusi | Langsung menyelesaikan masalah, aplikatif di sekolah | Relevan, aplikatif | Relevan tapi kurang aplikatif | Tidak relevan |

#### D.5 Contoh Soal Kuis Review

1. (BK) Apa langkah pertama dalam menyelesaikan masalah dengan dekomposisi? a) Mengeksekusi solusi b) Memecah masalah menjadi bagian kecil c) Mencari pola d) Membuat algoritma
2. (TIK) Perangkat lunak apa yang paling tepat untuk membuat presentasi? a) Microsoft Excel b) Google Slides c) Adobe Photoshop d) Visual Studio Code
3. (SK) Fungsi POST dalam proses booting adalah... a) Mematikan komputer b) Mengecek hardware c) Menginstal OS d) Membersihkan RAM
4. (JKI) Topologi apa yang paling cocok untuk jaringan laboratorium komputer? a) Bus b) Ring c) Star d) Mesh

### E. LEMBAR KERJA PESERTA DIDIK (LKPD)

**LKPD 16.1 — Perencanaan Proyek Mini**

Kelompok: _____________ Anggota: 1) ________ 2) ________ 3) ________ 4) ________

**Bagian A: Dekomposisi Masalah**
Masalah: Sekolah ingin menghemat penggunaan kertas.

| Sub-Masalah | Penyebab | Ide Solusi |
|---|---|---|
| Pengumpulan tugas cetak | ________ | ________ |
| Pengumuman kertas | ________ | ________ |
| ________ | ________ | ________ |

**Bagian B: Solusi Terpilih**
Solusi yang kami pilih: ________
Alasan: ________
Alat yang digunakan: ________
Pembagian peran: ________

**Bagian C: Rencana Presentasi**
- Poin utama yang akan disampaikan: ________
- Demonstrasi (jika ada): ________
- Pertanyaan antisipasi: ________

**Tantangan Bertingkat:**
- Level Dasar (C): Identifikasi 2 sub-masalah, 1 solusi, peran kelompok
- Level Menengah (B): Identifikasi 3 sub-masalah, 1 solusi detail, semua anggota punya peran
- Level Mahir (A): Identifikasi 3+ sub-masalah, solusi dengan analisis biaya-manfaat, prototype fungsional, video demo

### F. DIFERENSIASI PEMBELAJARAN

1. **Level Dasar (C):** Peran dalam kelompok: menjadi pencatat ide atau desainer visual. Produk bisa berupa poster digital sederhana. Kuis: mengurangi jumlah soal atau waktu lebih panjang.
2. **Level Menengah (B):** Peran sebagai kontributor ide dan pembuat konten. Produk presentasi slide yang rapi. Kuis standar.
3. **Level Mahir (A):** Peran sebagai pemimpin proyek atau teknisi. Produk bisa berupa prototype interaktif atau video. Kuis dengan soal tantangan (higher order thinking). Diminta membuat analisis biaya implementasi solusi.

### G. REFLEKSI GURU

1. Apakah kuis Kahoot/Quizizz efektif untuk review? Atau metode review lain yang lebih baik?
2. Apakah durasi 60 menit cukup untuk kerja proyek? Apakah perlu 3 JP?
3. Solusi apa yang paling kreatif muncul dari siswa? Apakah ada ide solusi yang bisa benar-benar diimplementasikan?
4. Apakah semua anggota kelompok berkontribusi? Bagaimana mengatasi anggota yang pasif?
5. Apakah proyek mini ini cukup merepresentasikan pemahaman lintas elemen?

### H. BAHAN BACAAN UNTUK GURU

1. **Project Based Learning dalam Informatika:** PjBL efektif untuk mengintegrasikan berbagai elemen dalam satu proyek nyata. Sintaks PjML: (1) Pertanyaan mendasar, (2) Desain proyek, (3) Jadwal, (4) Monitor, (5) Penilaian, (6) Evaluasi. Dalam konteks review lintas elemen, PjBL membantu siswa melihat keterkaitan antar konsep.
2. **Asesmen Autentik:** Proyek mini memberikan asesmen autentik — siswa dinilai dari produk nyata, bukan sekadar tes tertulis. Rubrik holistik lebih disarankan daripada rubrik analitik untuk proyek lintas elemen karena kompleksitas proyek sulit dipecah menjadi komponen terpisah.
3. **Dekomposisi dalam Konteks Nyata:** Kemampuan memecah masalah kompleks menjadi bagian lebih kecil adalah fondasi berpikir komputasional. Dalam proyek ini, dekomposisi diterapkan pada masalah pemborosan kertas — siswa belajar bahwa solusi digital tidak selalu berarti aplikasi rumit, bisa berupa perubahan proses sederhana yang didukung teknologi.
4. **Integrasi Lintas Elemen:** Proyek ini mengukur kemampuan siswa mengintegrasikan BK (dekomposisi & algoritma solusi), TIK (alat digital untuk presentasi), SK (apakah solusi membutuhkan server/komputer tertentu), dan JKI (apakah solusi membutuhkan jaringan internet). Kemampuan integrasi ini mencerminkan kesiapan siswa menghadapi dunia digital yang kompleks.
