...
## DSI: SEJARAH PERKEMBANGAN KOMPUTER
...
| Tujuan Pembelajaran | TP.8.1: Menjelaskan sejarah komputer & tokoh penting |
...
| Metode | Ceramah interaktif, diskusi kelompok, presentasi, penugasan riset, infografis |
...
2. Mengidentifikasi tokoh-tokoh penting dalam sejarah komputer dan kontribusinya masing-masing.
3. Menjelaskan perkembangan teknologi komponen komputer dari tabung vakum hingga mikroprosesor dan AI.
4. Menyajikan informasi sejarah komputer dalam bentuk infografis/poster secara berkelompok.
5. Menghubungkan perkembangan komputer masa lalu dengan teknologi komputasi yang digunakan saat ini.

#### B.2 Indikator Keberhasilan
| Indikator | Kriteria |
|---|---|
| 1. Menjelaskan generasi komputer | Mampu menyebutkan ciri khas, tahun, dan contoh komputer setiap generasi (1-5) |
| 2. Mengidentifikasi tokoh | Mampu menyebutkan 5 tokoh dan kontribusinya tanpa membuka catatan |
| 3. Perkembangan komponen | Mampu menjelaskan evolusi dari tabung vakum → transistor → IC → mikroprosesor |
| 4. Infografis | Poster memuat informasi lengkap, rapi, menarik, dan dipresentasikan dengan jelas |
| 5. Koneksi masa lalu-kini | Mampu memberikan 2 contoh teknologi sekarang yang merupakan hasil evolusi dari masa lalu |

#### B.3 Kata Kunci
Sejarah komputer, ENIAC, UNIVAC, tabung vakum, transistor, integrated circuit (IC), mikroprosesor, Charles Babbage, Ada Lovelace, Alan Turing, John von Neumann, generasi komputer, komputer mekanik, komputer elektronik, AI
...
| Pertanyaan | Tujuan |
|---|---|
| Sebutkan komputer pertama yang kalian ketahui! | Mengetahui pengetahuan awal tentang sejarah komputer |
| Siapa yang kalian anggap sebagai "bapak komputer"? | Mengidentifikasi pemahaman tentang tokoh penting |
| Menurut kalian, bagaimana komputer 50 tahun lalu dibandingkan sekarang? | Mengukur kemampuan analisis perbandingan |

#### D.2 Asesmen Formatif (Proses)
- Observasi partisipasi siswa dalam diskusi kelompok.
- Kualitas poster yang dibuat (kelengkapan informasi, kerapian, kreativitas).
- Kemampuan presentasi dan menjawab pertanyaan.

#### D.3 Asesmen Sumatif (Akhir)
- Produk poster infografis + presentasi kelompok.
- Tugas rumah: esai singkat tentang 1 tokoh IT Indonesia.
...
| **Kerja sama kelompok** | Semua anggota berkontribusi aktif, pembagian tugas merata | Sebagian besar anggota aktif | Hanya 2 orang yang aktif | Hanya 1 orang yang bekerja |

#### D.5 Contoh Soal
**Soal:** Buatlah timeline visual perkembangan komputer dari generasi 1 sampai generasi 5. Untuk setiap generasi, tuliskan:
1. Rentang tahun
2. Komponen utama yang digunakan
3. Contoh komputer pada generasi tersebut
4. Kelebihan dibanding generasi sebelumnya

### E. LEMBAR KERJA PESERTA DIDIK (LKPD)

**Nama:** __________________________ **Kelas:** X ___

**Kelompok:** ___________________ **Generasi/Tokoh:** ___________________

#### E.1 Lembar Riset Kelompok
Isi tabel berikut berdasarkan hasil riset kelompok Anda!

**Untuk tugas Generasi:**
| Aspek | Informasi |
|---|---|
| Nama Generasi | |
| Rentang Tahun | |
...
#### E.2 Lembar Presentasi
**Hal-hal yang harus ada dalam presentasi (3 menit):**
1. Perkenalan anggota kelompok dan pembagian tugas (30 detik)
2. Penyampaian informasi generasi/tokoh (1,5 menit)
3. Fakta unik atau hal menarik (30 detik)
4. Kesimpulan dan pesan (30 detik)

#### E.3 Tugas Individu — Riset Tokoh IT Indonesia
Cari informasi tentang salah satu tokoh IT Indonesia berikut (atau tokoh lain yang kalian ketahui):

1. **Onno W. Purbo** — pelopor internet Indonesia, pengembangan infrastruktur jaringan RT/RW-net
2. **Budi Rahardjo** — pakar keamanan siber Indonesia, pendiri Indonesia Hacker Foundation
3. **I Ketut Eddy Purnama** — penemu teknologi pemrosesan gambar untuk deteksi dini kanker
4. **Rahmat M. Samik Ibrahim** — pengembangan telematika Indonesia (NAF)

Tulis esai 1 paragraf yang mencakup: latar belakang, kontribusi, dan dampak karyanya bagi Indonesia!

### F. DIFERENSIASI PEMBELAJARAN

| Level | Deskripsi |
|---|---|
| **Level 1 (Bimbingan)** | Siswa diberikan lembar riset yang sudah berisi beberapa informasi yang dihapus (fill-in-the-blank) sehingga siswa hanya perlu mencari data yang hilang. Kelompok dibantu guru dalam pembagian tugas. Template poster disediakan. |
| **Level 2 (Reguler)** | Siswa meriset dari awal dengan panduan pertanyaan di LKPD. Kelompok menentukan sendiri pembagian tugas dan desain poster. |
| **Level 3 (Percepatan)** | Kelompok diberikan tantangan tambahan: membuat timeline interaktif menggunakan aplikasi (Canva/Prezi) yang menghubungkan antar generasi dan menunjukkan evolusi komponen. Siswa juga diminta menganalisis prediksi generasi 6 komputer di masa depan. |

### G. REFLEKSI GURU

| Aspek Refleksi | Catatan |
|---|---|
| Apakah siswa antusias dengan materi sejarah komputer? | |
| Apakah alokasi waktu untuk membuat poster cukup? | |
| Apakah presentasi berjalan efektif dan semua kelompok mendapat giliran? | |
| Bagian mana yang paling menarik perhatian siswa? | |

### H. BAHAN BACAAN UNTUK GURU

- **Buku Informatika Kelas X, Bab 8** — Penerbit Kemdikbudristek
- **"The Innovators: How a Group of Hackers, Geniuses, and Geeks Created the Digital Revolution" oleh Walter Isaacson** — buku komprehensif tentang tokoh-tokoh digital
- **Computer History Museum** — https://www.computerhistory.org/ — museum komputer virtual dengan koleksi artefak sejarah
- **Wikipedia — History of Computing** — https://en.wikipedia.org/wiki/History_of_computing — referensi lengkap timeline dan tokoh
