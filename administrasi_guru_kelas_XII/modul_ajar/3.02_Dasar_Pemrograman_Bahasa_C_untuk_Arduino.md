...
pertemuan: 2
total_pertemuan: 7
sub_judul: Dasar Pemrograman Bahasa C untuk Arduino
jp: 5
semester: 1
---

# MODUL AJAR Informatika — KELAS XII
## Pertemuan 2: Dasar Pemrograman Bahasa C untuk Arduino
...
| **Materi** | Dasar Pemrograman Bahasa C untuk Arduino |
...
3.2. Peserta didik mampu memahami dan menerapkan konsep dasar pemrograman bahasa c untuk arduino

## C. INDIKATOR KETERCAPAIAN TUJUAN PEMBELAJARAN
- Peserta didik mampu menjelaskan konsep dasar pemrograman bahasa c untuk arduino dengan benar
- Peserta didik mampu mengidentifikasi komponen/pilar utama dari dasar pemrograman bahasa c untuk arduino
- Peserta didik mampu menerapkan konsep dasar pemrograman bahasa c untuk arduino dalam studi kasus
...
{
"Keterkaitan materi ini dengan kehidupan nyata, misalnya bagaimana dasar pemrograman bahasa c untuk arduino digunakan dalam teknologi sehari-hari."
