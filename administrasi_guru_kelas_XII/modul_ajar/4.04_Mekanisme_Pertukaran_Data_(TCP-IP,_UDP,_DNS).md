...
pertemuan: 4
total_pertemuan: 5
sub_judul: Mekanisme Pertukaran Data (TCP/IP, UDP, DNS)
jp: 5
semester: 2
---

# MODUL AJAR Informatika — KELAS XII
## Pertemuan 4: Mekanisme Pertukaran Data (TCP/IP, UDP, DNS)
...
| **Materi** | Mekanisme Pertukaran Data (TCP/IP, UDP, DNS) |
...
4.4. Peserta didik mampu memahami dan menerapkan konsep mekanisme pertukaran data (tcp/ip, udp, dns)

## C. INDIKATOR KETERCAPAIAN TUJUAN PEMBELAJARAN
- Peserta didik mampu menjelaskan konsep mekanisme pertukaran data (tcp/ip, udp, dns) dengan benar
- Peserta didik mampu mengidentifikasi komponen/pilar utama dari mekanisme pertukaran data (tcp/ip, udp, dns)
- Peserta didik mampu menerapkan konsep mekanisme pertukaran data (tcp/ip, udp, dns) dalam studi kasus
...
{
"Keterkaitan materi ini dengan kehidupan nyata, misalnya bagaimana mekanisme pertukaran data (tcp/ip, udp, dns) digunakan dalam teknologi sehari-hari."
