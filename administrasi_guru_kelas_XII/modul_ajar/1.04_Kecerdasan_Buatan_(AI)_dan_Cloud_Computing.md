...
pertemuan: 4
total_pertemuan: 4
sub_judul: Kecerdasan Buatan (AI) dan Cloud Computing
jp: 5
semester: 1
---

# MODUL AJAR Informatika — KELAS XII
## Pertemuan 4: Kecerdasan Buatan (AI) dan Cloud Computing
...
| **Materi** | Kecerdasan Buatan (AI) dan Cloud Computing |
...
1.4. Peserta didik mampu memahami dan menerapkan konsep kecerdasan buatan (ai) dan cloud computing

## C. INDIKATOR KETERCAPAIAN TUJUAN PEMBELAJARAN
- Peserta didik mampu menjelaskan konsep kecerdasan buatan (ai) dan cloud computing dengan benar
- Peserta didik mampu mengidentifikasi komponen/pilar utama dari kecerdasan buatan (ai) dan cloud computing
- Peserta didik mampu menerapkan konsep kecerdasan buatan (ai) dan cloud computing dalam studi kasus
...
{
"Keterkaitan materi ini dengan kehidupan nyata, misalnya bagaimana kecerdasan buatan (ai) dan cloud computing digunakan dalam teknologi sehari-hari."
