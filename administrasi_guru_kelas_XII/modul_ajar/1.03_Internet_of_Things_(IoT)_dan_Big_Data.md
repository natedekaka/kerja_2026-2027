...
pertemuan: 3
total_pertemuan: 4
sub_judul: Internet of Things (IoT) dan Big Data
jp: 5
semester: 1
---

# MODUL AJAR Informatika — KELAS XII
## Pertemuan 3: Internet of Things (IoT) dan Big Data
...
| **Materi** | Internet of Things (IoT) dan Big Data |
...
1.3. Peserta didik mampu memahami dan menerapkan konsep internet of things (iot) dan big data

## C. INDIKATOR KETERCAPAIAN TUJUAN PEMBELAJARAN
- Peserta didik mampu menjelaskan konsep internet of things (iot) dan big data dengan benar
- Peserta didik mampu mengidentifikasi komponen/pilar utama dari internet of things (iot) dan big data
- Peserta didik mampu menerapkan konsep internet of things (iot) dan big data dalam studi kasus
...
{
"Keterkaitan materi ini dengan kehidupan nyata, misalnya bagaimana internet of things (iot) dan big data digunakan dalam teknologi sehari-hari."
