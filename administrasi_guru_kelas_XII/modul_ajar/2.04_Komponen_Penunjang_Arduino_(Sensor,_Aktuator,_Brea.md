...
pertemuan: 4
total_pertemuan: 7
sub_judul: Komponen Penunjang Arduino (Sensor, Aktuator, Breadboard)
jp: 5
semester: 1
---

# MODUL AJAR Informatika — KELAS XII
## Pertemuan 4: Komponen Penunjang Arduino (Sensor, Aktuator, Breadboard)
...
| **Materi** | Komponen Penunjang Arduino (Sensor, Aktuator, Breadboard) |
...
2.4. Peserta didik mampu memahami dan menerapkan konsep komponen penunjang arduino (sensor, aktuator, breadboard)

## C. INDIKATOR KETERCAPAIAN TUJUAN PEMBELAJARAN
- Peserta didik mampu menjelaskan konsep komponen penunjang arduino (sensor, aktuator, breadboard) dengan benar
- Peserta didik mampu mengidentifikasi komponen/pilar utama dari komponen penunjang arduino (sensor, aktuator, breadboard)
- Peserta didik mampu menerapkan konsep komponen penunjang arduino (sensor, aktuator, breadboard) dalam studi kasus
...
{
"Keterkaitan materi ini dengan kehidupan nyata, misalnya bagaimana komponen penunjang arduino (sensor, aktuator, breadboard) digunakan dalam teknologi sehari-hari."
